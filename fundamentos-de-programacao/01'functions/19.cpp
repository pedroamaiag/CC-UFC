...
int main() {
    ...
    cout << "Enter the withdrawal amount: "; cin >> withdrawal;

    bills result = exchange(withdrawal);

    cout << result.hundred << " bills of 100 reais were withdrawn" << endl;
    cout << result.fifty << " bills of 50 reais were withdrawn" << endl;
    cout << result.twenty << " bills of 20 reais were withdrawn" << endl;
    cout << result.ten << " bills of 10 reais were withdrawn" << endl;
    cout << result.five << " bills of 5 reais were withdrawn" << endl;
    cout << result.two << " bills of 2 reais were withdrawn" << endl;
    cout << result.one << " bills of 1 real were withdrawn" << endl;
